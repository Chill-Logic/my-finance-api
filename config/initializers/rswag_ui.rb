Rswag::Ui.configure do |c|
  ...
  c.openapi_endpoint '/api-docs/v1/accounts.yaml',        'Accounts'
  c.openapi_endpoint '/api-docs/v1/credit_balances.yaml', 'Credit Balances'
  c.openapi_endpoint '/api-docs/v1/credit_cards.yaml',    'Credit Cards'
